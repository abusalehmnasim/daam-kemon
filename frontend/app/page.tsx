    ...
    <div className="space-y-8">
      <section className="pt-8 text-center space-y-3">
        ...
        <p className="text-gray-600 max-w-xl mx-auto">
          Compare grocery prices across Chaldal, Shwapno, Othoba and Unimart — and find the cheapest
          way to buy your whole basket.
        </p>
      ...
      <section className="grid sm:grid-cols-3 gap-4 pt-6">
        <Feature
          ...
          body="We group the same product across stores — even when names, brands or spellings differ."
        />
        <Feature
          title="Basket optimization"
          body="Add everything you need; we find the cheapest single store and the best split."
        />
        <Feature
          title="Loose & packaged"
          body="Sugar, rice and dal sold loose are compared alongside branded packs, the way you actually shop."
        />
      </section>
    </div>
  );
